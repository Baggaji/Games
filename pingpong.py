...
pen.hideturtle()
pen.goto(0, 260)
pen.write("Player A: 0  Player B: 0", align="center", font=("Montserrat", 20, ""))
...
def play():
    ...
    while True:
        ...
        if ball.xcor() > 390:
            ...
            score_a += 1
            pen.clear()
            pen.write("Player A: {}  Player B: {}".format(score_a, score_b), align="center", font=("Montserrat", 20, ""))
